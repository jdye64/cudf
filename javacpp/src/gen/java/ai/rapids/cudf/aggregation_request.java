 ...
 */
@Namespace("cudf::groupby") @Properties(inherit = ai.rapids.cudf.presets.Cudf.class)
public class aggregation_request extends Pointer {
    ...
    @Override public aggregation_request getPointer(long i) {
        return new aggregation_request(this).position(position + i);
    }
  ...
  public native @StdVector std::unique_ptr<cudf::aggregation> aggregations(); public native aggregation_request aggregations(std::unique_ptr<cudf::aggregation> setter);
}
