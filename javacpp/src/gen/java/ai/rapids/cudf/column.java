...
public class column extends Pointer {
    ...
    @Override public column getPointer(long i) {
        return new column(this).position(position + i);
    }
   ...
   */
  public column(@Const @ByRef column other,
           @ByVal cuda_stream_view stream,
           device_memory_resource mr/*=rmm::mr::get_current_device_resource()*/) { super((Pointer)null); allocate(other, stream, mr); }
  private native void allocate(@Const @ByRef column other,
           @ByVal cuda_stream_view stream,
           device_memory_resource mr/*=rmm::mr::get_current_device_resource()*/);
  public column(@Const @ByRef column other,
           @ByVal cuda_stream_view stream) { super((Pointer)null); allocate(other, stream); }
  private native void allocate(@Const @ByRef column other,
           @ByVal cuda_stream_view stream);
   ...
   * @param mr Device memory resource to use for all device memory allocations
   */
  public column(@ByVal column_view view,
                    @ByVal(nullValue = "rmm::cuda_stream_view(rmm::cuda_stream_default)") cuda_stream_view stream,
                    device_memory_resource mr/*=rmm::mr::get_current_device_resource()*/) { super((Pointer)null); allocate(view, stream, mr); }
  private native void allocate(@ByVal column_view view,
                    @ByVal(nullValue = "rmm::cuda_stream_view(rmm::cuda_stream_default)") cuda_stream_view stream,
                    device_memory_resource mr/*=rmm::mr::get_current_device_resource()*/);
  public column(@ByVal column_view view) { super((Pointer)null); allocate(view); }
  private native void allocate(@ByVal column_view view);
   ...
   */
  public native @ByVal @NoException IntPointer size();
   ...
   */
  public native @ByVal IntPointer null_count();
  ...
  public native void set_null_mask(@ByVal device_buffer new_null_mask,
                       @ByVal(nullValue = "cudf::size_type(UNKNOWN_NULL_COUNT)") IntPointer new_null_count);
  public native void set_null_mask(@ByVal device_buffer new_null_mask);
   ...
   */
  public native void set_null_count(@ByVal IntPointer new_null_count);
   ...
   */
  public native @ByRef @NoException column child(@ByVal IntPointer child_index);
  ...
  public static class contents extends Pointer {
      ...
      @Override public contents getPointer(long i) {
          return new contents(this).position(position + i);
      }
    ...
    public native @ByRef VectorUniqueColumnPointer children(); public native contents children(VectorUniqueColumnPointer setter);
  }
   ...
   */
  public native @ByVal @Name("operator column_view") column_view asColumn_view();
   ...
   */
  public native @ByVal @Name("operator mutable_column_view") mutable_column_view asMutable_column_view();
}
