...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "custreamz._lib.io",
        "sources": [
            "custreamz/_lib/io.pyx"
        ]
    },
    "module_name": "custreamz._lib.io"
}
END: Cython Metadata */
...
#define __PYX_HAVE__custreamz___lib__io
#define __PYX_HAVE_API__custreamz___lib__io
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'custreamz._lib.io' */
#define __Pyx_MODULE_NAME "custreamz._lib.io"
extern int __pyx_module_is_main_custreamz___lib__io;
int __pyx_module_is_main_custreamz___lib__io = 0;

/* Implementation of 'custreamz._lib.io' */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_custreamz___lib__io) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "custreamz._lib.io")) {
      if (unlikely(PyDict_SetItemString(modules, "custreamz._lib.io", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init custreamz._lib.io", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init custreamz._lib.io");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
