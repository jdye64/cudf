 ...
 *freed when {@code column_view_base} objects are created or destroyed.
 *
 ...
 *
 **/
@Namespace("cudf::detail") @NoOffset @Properties(inherit = ai.rapids.cudf.presets.cudf.class)
public class column_view_base extends Pointer {
   ...
   **/
  public native @ByVal @NoException IntPointer is_empty();
   ...
   * the range [begin, end).
   *
   * @throws cudf::logic_error for invalid range (if {@code begin < 0},
   * {@code begin > end}, {@code begin >= size()}, or {@code end > size()}).
   *
   * @param begin [in] The starting index of the range (inclusive).
   * @param end [in] The index of the last element in the range (exclusive).
   **/
  public native @ByVal IntPointer null_count(@ByVal IntPointer begin, @ByVal IntPointer end);
   ...
   */
  public native @Cast("bool") boolean has_nulls(@ByVal IntPointer begin, @ByVal IntPointer end);
   ...
   **/
  public native @ByVal @NoException IntPointer offset();
}
